...
for i in range(4):
    ...
    clientsocket.send(b'\x08\x00\x00\x01\x41\xA2\x00\x00\x00\x00\x00\x02\x00')
    clientsocket.send(b'\x08\x00\x00\x01\x42\xA2\x00\x00\x00\x00\x00\xFE\xFF')
    time.sleep(6)
    ...
    clientsocket.send(b'\x08\x00\x00\x01\x41\xA2\x00\x00\x00\x00\x00\xFE\xFF')
    clientsocket.send(b'\x08\x00\x00\x01\x42\xA2\x00\x00\x00\x00\x00\x02\x00')
    time.sleep(12)

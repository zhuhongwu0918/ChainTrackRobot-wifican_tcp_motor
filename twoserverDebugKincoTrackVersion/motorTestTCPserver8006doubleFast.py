...
for i in range(10):
    ...
    clientsocket.send(b'\x08\x00\x00\x01\x41\xA2\x00\x00\x00\x00\x00\x04\x00')
    clientsocket.send(b'\x08\x00\x00\x01\x42\xA2\x00\x00\x00\x00\x00\xFC\xFF')
    time.sleep(3)
    ...
    clientsocket.send(b'\x08\x00\x00\x01\x41\xA2\x00\x00\x00\x00\x00\xFC\xFF')
    clientsocket.send(b'\x08\x00\x00\x01\x42\xA2\x00\x00\x00\x00\x00\x04\x00')
    time.sleep(6)
